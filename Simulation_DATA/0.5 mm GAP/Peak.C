...
TH1F*MeanPosX = new TH1F("MeanPosX","Mean Position - X axis;Position (mm);Counts",40,-10,60);

TH1F*MeanPosY= new TH1F("MeanPosY","Mean Position - Y axis;Position (mm);Counts",40,-10,60);
