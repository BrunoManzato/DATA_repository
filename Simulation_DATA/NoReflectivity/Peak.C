...
t->Draw("Detector_Number_Y>>HitsY");
...
TH1F*MeanPosX = new TH1F("MeanPosX","Mean Position - X axis;Position;Counts",48,17,23);

TH1F*MeanPosY= new TH1F("MeanPosY","Mean Position - Y axis;Position;Counts",48,17,23);
