...
t->Add(Form("/home/bruno/Documents/PSSimulation/OUTPUT/TestFiberNumberV2/output%d.root",ex));

double FiberNumber = 10+5*ex;

TH1F*HitsX = new TH1F("HitsX","Hits in X direction;Fiber channel; Counts",FiberNumber+6,-1.,FiberNumber+5);
